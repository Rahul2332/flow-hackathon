                ...
                <div className="bg-white h-100" style={{ width: '35%' }}>
                    <div className="container d-flex flex-column my-auto h-100 justify-content-center">
                        ...
                        <div className="px-3 py-4">
                            ...
                            <Button className="container fw-bold my-3" variant='contained' style={{backgroundColor:'#9467fe',textTransform:'capitalize'}}>Login</Button>

                            <p className="mt-5">Don't have an account ?</p>
                            <Button className="container fw-bold mb-3" variant='outlined' style={{borderColor:'#9467fe', color:'#9467fe',textTransform:'capitalize'}}>Sign Up</Button>
                        </div>
                    </div>
                </div>
            </div>
