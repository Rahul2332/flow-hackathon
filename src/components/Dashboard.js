                    ...
                    <div className="row" style={{ backgroundColor: 'rgb(244,239,255)' }}>
                        ...
                        <div className="col-4" style={{ backgroundColor: 'rgb(244,239,255)' }}>
                            <Tabs
                                ...
                                justify
                            >
                                <Tab className='pt-4 shadow-sm bg-white' style={{ borderRadius: '0 0 20px 20px' }} eventKey="buy" title="BUY">
                                    <div className='container px-5 pb-3'>
                                        ...
                                        {/* <TextField className='w-100' id="filled-basic" label="USDT" placeholder='0.00' variant="filled" /> */}
                                        <div className="input-group mb-3 ">
                                            <input disabled type="text" className="form-control" placeholder="0.00" />
                                            <span className="input-group-text">FLOW</span>
                                        </div>
                                        <div className='d-flex justify-content-center py-3'>
                                            <Button className='fw-bold px-5 py-2' style={{ background: '#9568ff' }} variant='contained'>Buy</Button>
                                        </div>
                                    </div>
                                </Tab>
                                <Tab className='pt-4 shadow-sm bg-white' style={{ borderRadius: '0 0 20px 20px' }} eventKey="sell" title="SELL">
                                    <div className='container px-5 pb-3'>
                                        ...
                                        <div className='d-flex justify-content-center py-3'>
                                            <Button className='fw-bold px-5 py-2' style={{ background: '#9568ff' }} variant='contained'>Sell</Button>
                                        </div>
                                    </div>
                                </Tab>
                            </Tabs>
