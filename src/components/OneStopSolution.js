                ...
                <div className="row">
                    <div className="col">
                        <div className="icon-bx-wraper style-3 shadow-lg rounded-4 my-3" style={{ height: '350px', width: '320px' }}>
                            ...
                            <p className="text-center text-secondary">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
                        </div>
                    </div>
                    <div className="col">
                        <div className="icon-bx-wraper style-3 shadow-lg rounded-4 my-3" style={{ height: '350px', width: '320px' }}>
                            ...
                            <div className="icon-content">
                                <h3 className="title fw-bold text-center">Support</h3>
                            </div>
                            <p className="text-center text-secondary">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
                        </div>
                    </div>
                    <div className="col">
                        <div className="icon-bx-wraper style-3 shadow-lg rounded-4 my-3" style={{ height: '350px', width: '320px' }}>
                            ...
                            <div className="icon-content">
                                <h3 className="title fw-bold text-center">Fast and Easy KYC</h3>
                            </div>
                            <p className="text-center text-secondary">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
                        </div>
                    </div>
