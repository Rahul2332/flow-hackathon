                    ...
                    <div className="w-50 px-4">
                        <div className="row p-4 text-white rounded-4 icon-bx-wraper style-2" style={{ width: '100%', backgroundColor: '#362465' }}>
                            ...
                            <div className="col-8">
                                ...
                                <p className='mt-3' style={{ color: '#c5cdff' }}>Our revolutionary stock exchange powered by cryptocurrency brings lightning-fast trades and unparalleled security to the world of investing.</p>
                    ...
                    <div className="w-50 px-4">
                        <div className="row p-4 text-white rounded-4 icon-bx-wraper style-2" style={{ width: '100%', backgroundColor: '#362465' }}>
                            ...
                            <div className="col-8">
                                ...
                                <p className='mt-3' style={{ color: '#c5cdff' }}>Liquidity Pooling can help to increase liquidity and reduce volatility, making it easier for traders to buy and sell cryptocurrencies at stable prices.</p>
                                <Button variant='contained' style={{ textTransform: 'capitalize' }} className="my-2 fw-bold px-4 py-2 rounded-3 btn-gradient" >Invest Now</Button>
                            </div>
                        </div>
                    </div>
